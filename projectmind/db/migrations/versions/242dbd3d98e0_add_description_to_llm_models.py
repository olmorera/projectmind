"""Add description to llm_models

Revision ID: 242dbd3d98e0
Revises: 52428bf419c9
Create Date: 2025-05-22 11:42:11.960269
...
revision: str = '242dbd3d98e0'
down_revision: Union[str, None] = '52428bf419c9'
...
def upgrade() -> None:
    ...
    op.add_column('llm_models', sa.Column('description', sa.String(), nullable=True))
