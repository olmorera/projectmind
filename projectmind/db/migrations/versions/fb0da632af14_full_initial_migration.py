...
Revision ID: fb0da632af14
Revises: 
Create Date: 2025-05-21 02:23:57.761150
...
def upgrade() -> None:
    ...
    op.add_column('memories', sa.Column('project_id', sa.String(), nullable=True))
    op.add_column('memories', sa.Column('agent_name', sa.String(), nullable=True))
    op.add_column('memories', sa.Column('task_type', sa.String(), nullable=True))
    op.alter_column('memories', 'key',
...
def downgrade() -> None:
    ...
    op.alter_column('memories', 'key',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('memories', 'task_type')
    op.drop_column('memories', 'agent_name')
