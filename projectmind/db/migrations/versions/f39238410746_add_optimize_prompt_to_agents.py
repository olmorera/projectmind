"""Add optimize_prompt to agents

Revision ID: f39238410746
Revises: e10065d7edbb
Create Date: 2025-05-21 01:31:16.943099
...
revision: str = 'f39238410746'
down_revision: Union[str, None] = 'e10065d7edbb'
...
def upgrade() -> None:
    ...
    op.add_column('agents', sa.Column('optimize_prompt', sa.Boolean(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('agents', 'optimize_prompt')
